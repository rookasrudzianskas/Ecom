              ...
              <div className={'bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden'}>
                ...
                <div className={'flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center'}>
                  <div className={'flex items-center'}>
                    <span className={`px-3 py-1 rounded-full text-sm ${order.status === "paid" ? "bg-green-100" +
                      " text-green-800" : "bg-gray-100 text-gray-800"}`}>{order.status}</span>
                  </div>
                  <div className={'sm:text-right'}>
                  ...
                  <div className={'space-y-3 sm:space-y-4'}>
                    {order.products?.map((product) => (
                      <div
                        ...
                        className={'flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 py-2 border-b' +
                          ' last:border-b-0'}
                      >
                        <div className={'flex items-center gap-3 sm:gap-4'}>
                          {product.product?.image && (
                            <div className={'relative h-14 w-14 sm:h-16 sm:w-16 flex-shrink-0 rounded-md' +
                              ' overflow-hidden'}>
                              <Image
